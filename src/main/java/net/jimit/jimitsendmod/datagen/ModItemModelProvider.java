...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    // Helper method created by El_Redstoniano. Don't have access to the built-in minecraft method.
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = JimitsEndMod.MOD_ID; // Change this to your mod id
